...
module UniversalApi
  module Controller
    ...
    class UniversalApiError < StandardError; end
    class ModelError < UniversalApiError; end
    class NoParamsError < UniversalApiError; end
    ...
    protected
      ...
      def permitted_params
        err_msg = 'No params sent'

        respond_to do |format|
          format.json do
            raise NoParamsError, err_msg unless params[_wrapper_options.name]
          ...
          format.xml do
            ...
            raise NoParamsError, err_msg unless data.is_a?(Hash)
      ...
      def prepare_model
        err_msg = 'Model class is not ActiveRecord'
        model_name = get_model_name

        raise ModelError, "Model class not present" if model_name.nil? || model_name.strip == ""

        @model_class = model_name.constantize

        raise ModelError, err_msg unless @model_class < ActiveRecord::Base
      rescue NameError
